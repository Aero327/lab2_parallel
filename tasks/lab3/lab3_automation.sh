...
INPUT_SIZES=(100 100000 10000000)
CORES=(1 3 5)
REPEATS=10
EXECUTABLES=(
  first_seq=array_oper_seq.c
  first_par=array_oper_par.c
  second_seq=array_sort_seq.c
  second_par=array_sort_par.c
  third_seq=array_sum_seq.c
  third_par=array_sum_par.c
  fourth_seq=matrix_oper_seq.c
  fourth_par=matrix_oper_par.c
)
